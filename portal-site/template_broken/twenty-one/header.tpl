        ...
        <nav class="navbar navbar-expand-xl zt-navbar">
            <div class="container zt-navbar-inner">
                <a class="navbar-brand zt-brand" href="{$WEB_ROOT}/index.php">
                    <img src="{$WEB_ROOT}/templates/{$template}/img/logo.png" alt="{$companyname}" class="zt-logo-img" onerror="{if $assetLogoPath}this.onerror=null;this.src='{$assetLogoPath}';{else}this.style.display='none';{/if}">
                </a>
