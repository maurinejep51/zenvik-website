            ...
            <div class="zt-footer-grid">
                <div class="zt-footer-column zt-footer-company">
                    <a class="zt-footer-brand" href="{$WEB_ROOT}/index.php">
                        <img src="{$WEB_ROOT}/templates/twenty-one/img/logo.png" alt="{$companyname}" class="zt-footer-logo" onerror="{if $assetLogoPath}this.onerror=null;this.src='{$assetLogoPath}';{else}this.style.display='none';{/if}">
                    </a>
